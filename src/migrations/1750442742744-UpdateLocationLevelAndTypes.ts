	...
	implements MigrationInterface
{
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`CREATE TABLE "location_levels" ("id" uniqueidentifier NOT NULL, "key" varchar(30) NOT NULL, "label_key" varchar(50) NOT NULL, "countryId" uniqueidentifier NOT NULL, CONSTRAINT "PK_0a52cdeb5ae4b2f5a3e5a3be928" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "location_levels" ADD CONSTRAINT "FK_5167cc20782d249100bbda44846" FOREIGN KEY ("countryId") REFERENCES "countries"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
	}

	public async down(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`ALTER TABLE "location_levels" DROP CONSTRAINT "FK_5167cc20782d249100bbda44846"`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(`DROP TABLE "location_levels"`);
	}
}
